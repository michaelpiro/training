...
class Pipline():
    ...
    def __init__(
        ...
        self.vae = torch.load(os.path.join(models_dir, "vae"))
        self.unet = torch.load(os.path.join(models_dir, "unet"))
        self.scheduler = torch.load(os.path.join(models_dir, "scheduler"))
        self.vocoder = torch.load(os.path.join(models_dir, "vocoder"))
